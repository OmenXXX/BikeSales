...
export const AuthProvider = ({ children }) => {
    ...
    const logout = async (global = false, message = null) => {
        ...
        try {
            ...
            if (recordId) {
                ...
                }, true).catch(err => console.warn("FM Logout update failed", err));
            }
            ...
            const redirectUrl = message ? `/?msg=${encodeURIComponent(message)}` : '/';
            window.location.href = redirectUrl; // Force a clean slate
        } catch (error) {
