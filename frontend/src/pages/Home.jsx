...
const Home = () => {
    ...
    const modules = [
        ...
        { id: 'inventory', label: 'Products', icon: 'inventory_2', dr: 1, dc: 2, mc: 0, mr: 2, colors: 'from-blue-500 to-indigo-500', accent: 'text-blue-600' },
        { id: 'reports', label: 'Reports', icon: 'insights', dr: 2, dc: 0, mc: 1, mr: 2, colors: 'from-rose-500 to-orange-500', accent: 'text-rose-600' },
        { id: 'partners', label: 'Business Partners', icon: 'contacts', dr: 2, dc: 1, mc: 0, mr: 3, colors: 'from-teal-500 to-emerald-500', accent: 'text-teal-600' },
    ];
