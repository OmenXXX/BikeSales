...
const AdminSidebar = ({
    ...
    const links = [
        { id: 'company', label: 'Company Details', icon: 'business', view: 'company' },
        { id: 'employees', label: 'Employees', icon: 'people', view: 'employees' },
        { id: 'structure', label: 'Structure', icon: 'hub', view: 'structure', adminOnly: true },
        { id: 'product-preferences', label: 'Product Prefs', icon: 'settings_suggest', view: 'product-preferences', adminOnly: true },
    ];
        ...
        <div className="w-20 flex-shrink-0 relative z-50 h-full">
            ...
            >
                ...
                <nav className="flex-1 py-10 px-3 space-y-4 relative z-10">
                    {links.map((link) => {
                        if (link.adminOnly && role !== 'Administrator') return null;
                        
                        const isActive = activeView === link.view || 
                                       (link.id === 'employees' && activeView === 'detail') ||
                                       (link.id === 'partners' && activeView === 'partner-detail');
