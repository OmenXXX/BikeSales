...
const EmployeeDetail = ({
    ...
    const isActive = data.z_active_state === 'ACTIVE';
        ...
        <div className="max-w-7xl mx-auto space-y-4 animate-slide-up pb-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white p-5 rounded-[2rem] border border-slate-100 shadow-sm">
                ...
                <div className="flex items-center gap-4">
                    <div className="w-16 h-16 rounded-[1.2rem] overflow-hidden shadow-lg border-2 border-slate-50 relative group bg-slate-50 flex items-center justify-center">
                        {data.photo ? (
                            <img
                                src={data.photo}
                                alt={data.Name_First}
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            <div className="px-1.5 py-0.5 rounded-md bg-slate-100 text-[9px] font-black text-slate-500 tracking-widest uppercase truncate max-w-[150px]">ID: {data.Role || 'Staff Member'}</div>
                        </div>
                    </div>
                </div>
                            ...
                            {canEdit ? (
                                !isEditing ? (
                                    <Tooltip text="Modify Employee Record">
                                        ...
                                        >
                                            <span className="material-icons-round text-base" style={{ color: primaryColor }}>edit</span>
                                            Edit
                                        </button>
                                    </Tooltip>
                                ) : (
                                    <>
                                        <Tooltip text="Save All Changes">
                                            <button
                                                ...
                                                className="px-5 py-2.5 rounded-xl bg-[#1a1d21] text-white font-black text-[10px] uppercase tracking-widest shadow-lg hover:bg-slate-800 transition-all border border-emerald-500/30"
                                            >
                                                Save
                                            </button>
                                        </Tooltip>
                                ...
                                <div className="flex items-center gap-3 px-5 py-2.5 rounded-xl bg-slate-50 border border-slate-100 opacity-60">
                ...
                <div className="space-y-4">
                    <div className="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm relative overflow-hidden h-full">
                        ...
                        <div className="flex items-start gap-5 mb-8">
                            <div className="w-20 h-20 rounded-[1.5rem] bg-slate-50 border-4 border-slate-50 overflow-hidden shadow-inner flex-shrink-0 flex items-center justify-center">
                                {data.photo ? (
                                    <img
                                        src={data.photo}
                                        className="w-full h-full object-cover"
